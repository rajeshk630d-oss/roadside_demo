...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="{{route('aaaDriver.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="id_no"
                                               id="id_no" placeholder="ID No." value="{{old('id_no')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="submit" value="Create Driver" class="btn btn-success float-right">
                    </div>
                </div>
            </form>
        </section>
