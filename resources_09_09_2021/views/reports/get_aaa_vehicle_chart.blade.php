    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>AAA Vehicle Jobs Chart</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('/home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{route('reports')}}">Reports</a></li>
                            <li class="breadcrumb-item active">AAA Vehicle Jobs Chart</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form action="{{route('viewAAAVehicleChart')}}" method="post">
                                    {{ csrf_field() }}
                                    {{--<div class="form-group row">--}}
                                        ...
                                        {{--<div class="col-5">--}}
                                            {{--<select class="select2" multiple="multiple" name="area_id[]" id="area_id[]"--}}
                                                    {{--data-placeholder="Select Areas" style="width: 100%;">--}}
