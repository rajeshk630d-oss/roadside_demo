...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('customerContracts.index')}}">Customer Contracts</a></li>
        ...
        <section class="content">
            <form action="{{route('customerContracts.update' , $contract->id)}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="select2" name="customers_id" id="customers_id"
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <?php
                                                        $select = "";
                                                        if($customer->id == $contract->customers_id){
                                                            $select = "SELECTED";
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="select2" name="service_master_id" id="service_master_id"
                                                    ...
                                                    @foreach($services as $service)
                                                        <?php
                                                        $select = "";
                                                        if($service->id == $contract->service_master_id){
                                                            $select = "SELECTED";
                                                        }
                                                        ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" step="0.001" class="form-control" name="charges"
                                                       id="charges" placeholder="Charges" value="{{$contract->charges}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input  class="form-control" name="free_services_contract"
                                                        id="free_services_contract" placeholder="Free Services or contract"
                                                        value="{{$contract->free_services_contract}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" step="0.001" class="form-control" name="minimum_km"
                                                       id="minimum_km" value="{{$contract->minimum_km}}" placeholder="Minimum KM">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" step="0.001" class="form-control" name="extracharges_km"
                                                       id="extracharges_km" value="{{$contract->extracharges_km}}"
                                                       placeholder="Extra changes per KM">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="payment_terms"
                                                       value="{{$contract->payment_terms}}" id="payment_terms" placeholder="Payment Terms">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                            ...
                            <div class="card-footer">
                                ...
                                <input type="submit" value="Update Contract" class="btn btn-success float-right">
                            </div>
                        </div>
                    </div>
                </div>
