...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="{{route('contractorVehicles.update' , $vehicle->id)}}" method="post">
                {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="select2" name="contractor_master_id" id="contractor_master_id"
                                                    ...
                                                    @foreach($contractors as $contractor)
                                                        <?php
                                                        $select = "";
                                                        if($contractor->id == $vehicle->contractor_master_id){
                                                            $select = "SELECTED";
                                                        }
                                                        ?>
                            ...
                            <div class="card-footer">
                                ...
                                <input type="submit" value="Update Contractor Vehicle" class="btn btn-success float-right">
                            </div>
                        </div>
                    </div>
                </div>
