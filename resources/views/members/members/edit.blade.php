            ...
            <form action="{{route('members.update' , $member->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="membership_no"  name="membership_no" value="{{$member->membership_no}}" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="membership_type_id" id="membership_type_id"
                                                ...
                                                @foreach($membership_types as $type)
                                                    <?php
                                                    $select = "";
                                                    if($type->id == $member->membership_type_id){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2"name="customer_id" id="customer_id"
                                                ...
                                                @foreach($customers as $customer)
                                                    <?php
                                                    $select = "";
                                                    if($customer->id == $member->customer_id){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="vehicle_no"  name="vehicle_no" value="{{$member->vehicle_no}}"
                                                   placeholder="Enter Vehicle Number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="chassis_no">Chassis No *</label>
                                            <input type="text" id="chassis_no"  name="chassis_no" value="{{$member->chassis_no}}"
                                                   placeholder="Enter Chassis Number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="engine_no">Engine No *</label>
                                            <input type="text" id="engine_no"  name="engine_no" value="{{$member->engine_no}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="member_name"  name="member_name" value="{{$member->member_name}}" class="form-control">
                                            ...
                                            <select class="select2" name="vehicle_brand_id" id="vehicle_brand_id"
                                                ...
                                                @foreach($brands as $brand)
                                                    <?php
                                                    $select = "";
                                                    if($brand->id == $member->vehicle_brand_id){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="vehicle_type_id" id="vehicle_type_id"
                                                ...
                                                @foreach($vehicle_types as $vehicle_type)
                                                    <?php
                                                    $select = "";
                                                    if($vehicle_type->id == $member->vehicle_type_id){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="vehicle_reg_type_id" id="vehicle_reg_type_id"
                                                ...
                                                @foreach($vehicle_reg_types as $type)
                                                    <?php
                                                    $select = "";
                                                    if($type->id == $member->vehicle_reg_type_id){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
                                                    <option value="{{$type->id}}" {{$select}} >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="mfg_year"  name="mfg_year" value="{{$member->mfg_year}}" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="expiry_date">Expiry Date *</label>
                                            <input type="date" id="expiry_date"  name="expiry_date" value="{{$member->expiry_date}}" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="ref_no">Reference No.</label>
                                            <input type="text" id="ref_no"  name="ref_no" value="{{$member->ref_no}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="submit" value="Update Member" class="btn btn-success float-right">
                    </div>
                </div>
            </form>
        </section>
