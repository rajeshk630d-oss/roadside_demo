...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="{{route('memberVehicles.update' , $vehicle->id)}}" method="post">
                {{csrf_field()}}
                                            ...
                                            <div class="col-sm-10">
                                                <select class="select2" name="membership_type_id" id="membership_type_id"
                                                    ...
                                                    @foreach($membership_types as $type)
                                                        <?php
                                                        $select = "";
                                                        if($type->id == $vehicle->contractor_master_id){
                                                            $select = "SELECTED";
                                                        }
                                                        ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="membership_no" id="membership_no"
                                                       placeholder="membership no" value="{{$vehicle->membership_no}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="vehicle_registration_no"
                                                       id="vehicle_registration_no" placeholder="Vehicle registration No" value="{{$vehicle->vehicle_registration_no}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="mfg_year" id="mfg_year"
                                                       placeholder="MFG Year" value="{{$vehicle->mfg_year}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
