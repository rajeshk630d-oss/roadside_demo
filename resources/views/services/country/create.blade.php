    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Add Service Country</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{route('serviceCountry.index')}}">Service Countries</a></li>
                            <li class="breadcrumb-item active">Add Service Country</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <form action="{{route('serviceCountry.store')}}" method="post">
                {{csrf_field()}}
                <div class="row">
