                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form action="{{route('viewBatchReport')}}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label for="batch" class="col-sm-2 col-form-label" style="text-align: right">Batch : </label>
                                        <div class="col-3">
                                            <select class="select2" name="batch_no" id="batch_no" style="width: 100%;"
                                                ...
                                                @foreach($batches as $batch)
                                                    <?php
                                                    $select = "";
                                                    if($batch->batch_no == old('batch_no')){
                                                        $select = "SELECTED";
                                                    }
                                                    ?>
