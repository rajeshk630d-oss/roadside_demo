...
{{--                                        <li><a href="{{ route('getAreaSummeryChart') }}">Area Summery Chart</a></li>--}}
                                    ...
                                    @endif
                                    @if(is_have_access(103))
                                        <li><a href="{{ route('getCustomerCostAnalysisReport') }}">Customer Cost Analysis Report</a></li>
                                    @endif
                                    @if(is_have_access(103))
                                        <li><a href="{{ route('getSubContractorsReport') }}">Sub Contractors Report</a></li>
                                    @endif
                                     @if(is_have_access(103))
                                        <li><a href="{{ route('getSubContractorsBatchReport') }}">Sub Contractors Batch Report</a></li>
                                    @endif
                                     @if(is_have_access(103))
                                        <li><a href="{{ route('get_jobs_list') }}">Jobs list</a></li>
                                    @endif
                                </ol>
                            </div>
